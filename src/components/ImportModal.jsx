export default function ImportModal({ lineup, existingLineup, onAdd, onUpdate, onCancel }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-end justify-center z-50 sm:items-center">
      <div className="bg-slate-800 rounded-t-2xl sm:rounded-2xl border border-slate-600 w-full max-w-sm p-6">
        <div className="mb-4">
        ...
        <div className="bg-slate-900 rounded-xl divide-y divide-slate-700/50 max-h-52 overflow-y-auto mb-5">
